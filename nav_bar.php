...
<nav class="navbar navbar-default top-nav">
    ...
    <div class="navbar-header">
      ...
      <?PHP print (strpos($_SERVER['PHP_SELF'], '/trout.php')) ? "<a href='#'' id='nav-trout'><img height='45px' src='img/trout.png'></a>" : "" ?>
       <?PHP print (strpos($_SERVER['PHP_SELF'], '/tunes.php')) ? "<a class='navbar-brand'  href='#'' id='brand'>myFavoriteTunes</a>" : "" ?>
        <?PHP print (strpos($_SERVER['PHP_SELF'], '/login.php')) ? "<a class='navbar-brand'  href='#'' id='brand'>myFavoriteTunes</a>" : "" ?>
         <?PHP print (strpos($_SERVER['PHP_SELF'], '/register.php')) ? "<a class='navbar-brand'  href='#'' id='brand'>myFavoriteTunes</a>" : "" ?>
		</div>
      ...
      <ul class="nav navbar-nav hov-green">
        ...
        <li <?PHP print (strpos($_SERVER['PHP_SELF'], '/login.php')) ? "class='active2'" : "" ?> ><a href="login.php" class="sans" id="login"><span class="glyphicon glyphicon-log-in glyph-space-right"></span><span class="sans">LogIn</span></a></li>
        ...
        if(isLoggedIn()) {
          print "<li><a style='color:black'>LoggedIn: $username</a></li>";
